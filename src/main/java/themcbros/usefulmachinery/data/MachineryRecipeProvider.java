...
public class MachineryRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> recipe) {
        //Gears
        CompactingRecipeBuilder.compacting(ALUMINUM_GEAR, Ingredient.of(INGOTS_ALUMINUM), 4, 200, CompactorMode.GEAR).unlockedBy("has_aluminum", has(INGOTS_ALUMINUM)).save(recipe, getId("aluminum_gear_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(COPPER_GEAR, Ingredient.of(Tags.Items.INGOTS_COPPER), 4, 200, CompactorMode.GEAR).unlockedBy("has_copper", has(Tags.Items.INGOTS_COPPER)).save(recipe, getId("copper_gear_from_compacting"));
        CompactingRecipeBuilder.compacting(DIAMOND_GEAR, Ingredient.of(Tags.Items.GEMS_DIAMOND), 4, 200, CompactorMode.GEAR).unlockedBy("has_diamond", has(Tags.Items.GEMS_DIAMOND)).save(recipe, getId("diamond_gear_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(ENDERIUM_GEAR, Ingredient.of(INGOTS_ENDERIUM), 4, 200, CompactorMode.GEAR).unlockedBy("has_enderium", has(INGOTS_ENDERIUM)).save(recipe, getId("enderium_gear_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(PLATINUM_GEAR, Ingredient.of(INGOTS_PLATINUM), 4, 200, CompactorMode.GEAR).unlockedBy("has_platinum", has(INGOTS_PLATINUM)).save(recipe, getId("platinum_gear_from_compacting"));
        CompactingRecipeBuilder.compacting(SIGNALUM_GEAR, Ingredient.of(INGOTS_SIGNALUM), 4, 200, CompactorMode.GEAR).unlockedBy("has_signalum", has(INGOTS_SIGNALUM)).save(recipe, getId("signalum_gear_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(STEEL_GEAR, Ingredient.of(INGOTS_STEEL), 4, 200, CompactorMode.GEAR).unlockedBy("has_steel", has(INGOTS_STEEL)).save(recipe, getId("steel_gear_from_compacting"));
        ...
        //Storage Blocks
        CompactingRecipeBuilder.compacting(ALUMINUM_BLOCK, Ingredient.of(INGOTS_ALUMINUM), 9, 250, CompactorMode.BLOCK).unlockedBy("has_aluminum", has(INGOTS_ALUMINUM)).save(recipe, getId("aluminum_block_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(ENDERIUM_BLOCK, Ingredient.of(INGOTS_ENDERIUM), 9, 250, CompactorMode.BLOCK).unlockedBy("has_enderium", has(INGOTS_ENDERIUM)).save(recipe, getId("enderium_block_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(PLATINUM_BLOCK, Ingredient.of(INGOTS_PLATINUM), 9, 250, CompactorMode.BLOCK).unlockedBy("has_platinum", has(INGOTS_PLATINUM)).save(recipe, getId("platinum_block_from_compacting"));
        CompactingRecipeBuilder.compacting(SIGNALUM_BLOCK, Ingredient.of(INGOTS_SIGNALUM), 9, 250, CompactorMode.BLOCK).unlockedBy("has_signalum", has(INGOTS_SIGNALUM)).save(recipe, getId("signalum_block_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(STEEL_BLOCK, Ingredient.of(INGOTS_STEEL), 9, 250, CompactorMode.BLOCK).unlockedBy("has_steel", has(INGOTS_STEEL)).save(recipe, getId("steel_block_from_compacting"));
        ...
        //Plates
        CompactingRecipeBuilder.compacting(ALUMINUM_PLATE, Ingredient.of(INGOTS_ALUMINUM), 1, 200, CompactorMode.PLATE).unlockedBy("has_aluminum", has(INGOTS_ALUMINUM)).save(recipe, getId("aluminum_plate_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(COPPER_PLATE, Ingredient.of(Tags.Items.INGOTS_COPPER), 1, 200, CompactorMode.PLATE).unlockedBy("has_copper", has(Tags.Items.INGOTS_COPPER)).save(recipe, getId("copper_plate_from_compacting"));
        CompactingRecipeBuilder.compacting(DIAMOND_PLATE, Ingredient.of(Tags.Items.GEMS_DIAMOND), 1, 200, CompactorMode.PLATE).unlockedBy("has_diamond", has(Tags.Items.GEMS_DIAMOND)).save(recipe, getId("diamond_plate_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(ENDERIUM_PLATE, Ingredient.of(INGOTS_ENDERIUM), 1, 200, CompactorMode.PLATE).unlockedBy("has_enderium", has(INGOTS_ENDERIUM)).save(recipe, getId("enderium_plate_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(PLATINUM_PLATE, Ingredient.of(INGOTS_PLATINUM), 1, 200, CompactorMode.PLATE).unlockedBy("has_platinum", has(INGOTS_PLATINUM)).save(recipe, getId("platinum_plate_from_compacting"));
        CompactingRecipeBuilder.compacting(SIGNALUM_PLATE, Ingredient.of(INGOTS_SIGNALUM), 1, 200, CompactorMode.PLATE).unlockedBy("has_signalum", has(INGOTS_SIGNALUM)).save(recipe, getId("signalum_plate_from_compacting"));
        ...
        CompactingRecipeBuilder.compacting(STEEL_PLATE, Ingredient.of(INGOTS_STEEL), 1, 200, CompactorMode.PLATE).unlockedBy("has_steel", has(INGOTS_STEEL)).save(recipe, getId("steel_plate_from_compacting"));
        ...
        //Raw Materials
        CrushingRecipeBuilder.crushing(RAW_ALUMINUM, 2, Ingredient.of(ORES_ALUMINUM), 200).unlockedBy("has_aluminum_ore", has(ORES_ALUMINUM)).save(recipe, getId("raw_aluminum_from_ore"));
        ...
        CrushingRecipeBuilder.crushing(RAW_PLATINUM, 2, Ingredient.of(ORES_PLATINUM), 200).unlockedBy("has_platinum_ore", has(ORES_PLATINUM)).save(recipe, getId("raw_platinum_from_ore"));
        ...
        //Dusts
        CrushingRecipeBuilder.crushing(ALUMINUM_DUST, 1, Ingredient.of(INGOTS_ALUMINUM), 200).unlockedBy("has_aluminum", has(INGOTS_ALUMINUM)).save(recipe, getId("aluminum_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(BRONZE_DUST, 1, Ingredient.of(INGOTS_BRONZE), 200).unlockedBy("has_bronze", has(INGOTS_BRONZE)).save(recipe, getId("bronze_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(COPPER_DUST, 1, Ingredient.of(Tags.Items.INGOTS_COPPER), 200).unlockedBy("has_copper", has(Tags.Items.INGOTS_COPPER)).save(recipe, getId("copper_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(DIAMOND_DUST, 1, Ingredient.of(Tags.Items.GEMS_DIAMOND), 200).unlockedBy("has_diamond", has(Tags.Items.GEMS_DIAMOND)).save(recipe, getId("diamond_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(ELECTRUM_DUST, 1, Ingredient.of(INGOTS_ELECTRUM), 200).unlockedBy("has_electrum", has(INGOTS_ELECTRUM)).save(recipe, getId("electrum_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(ENDERIUM_DUST, 1, Ingredient.of(INGOTS_ENDERIUM), 200).unlockedBy("has_enderium", has(INGOTS_ENDERIUM)).save(recipe, getId("enderium_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(GOLD_DUST, 1, Ingredient.of(Tags.Items.INGOTS_GOLD), 200).unlockedBy("has_gold", has(Tags.Items.INGOTS_GOLD)).save(recipe, getId("gold_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(INVAR_DUST, 1, Ingredient.of(INGOTS_INVAR), 200).unlockedBy("has_invar", has(INGOTS_INVAR)).save(recipe, getId("invar_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(IRON_DUST, 1, Ingredient.of(Tags.Items.INGOTS_IRON), 200).unlockedBy("has_iron", has(Tags.Items.INGOTS_IRON)).save(recipe, getId("iron_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(LEAD_DUST, 1, Ingredient.of(INGOTS_LEAD), 200).unlockedBy("has_lead", has(INGOTS_LEAD)).save(recipe, getId("lead_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(NICKEL_DUST, 1, Ingredient.of(INGOTS_NICKEL), 200).unlockedBy("has_nickel", has(INGOTS_NICKEL)).save(recipe, getId("nickel_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(PLATINUM_DUST, 1, Ingredient.of(INGOTS_PLATINUM), 200).unlockedBy("has_platinum", has(INGOTS_PLATINUM)).save(recipe, getId("platinum_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(SIGNALUM_DUST, 1, Ingredient.of(INGOTS_SIGNALUM), 200).unlockedBy("has_signalum", has(INGOTS_SIGNALUM)).save(recipe, getId("signalum_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(SILVER_DUST, 1, Ingredient.of(INGOTS_SILVER), 200).unlockedBy("has_silver", has(INGOTS_SILVER)).save(recipe, getId("silver_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(STEEL_DUST, 1, Ingredient.of(INGOTS_STEEL), 200).unlockedBy("has_steel", has(INGOTS_STEEL)).save(recipe, getId("steel_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(TIN_DUST, 1, Ingredient.of(INGOTS_TIN), 200).unlockedBy("has_tin", has(INGOTS_TIN)).save(recipe, getId("tin_dust_from_crushing"));
        CrushingRecipeBuilder.crushing(URANIUM_DUST, 1, Ingredient.of(INGOTS_URANIUM), 200).unlockedBy("has_uranium", has(INGOTS_URANIUM)).save(recipe, getId("uranium_dust_from_compacting"));
        ...
        ShapedRecipeBuilder.shaped(CRUSHER, 1).pattern(" X ").pattern("#R#").pattern("IBI").define('X', Tags.Items.DUSTS_REDSTONE).define('#', Items.FLINT).define('R', MACHINE_FRAME).define('I', Tags.Items.INGOTS_COPPER).define('B', BATTERIES).unlockedBy("has_machine_frame", has(MACHINE_FRAME)).save(recipe);
