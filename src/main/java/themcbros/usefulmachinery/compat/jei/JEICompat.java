...
public class JEICompat implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(CoalGeneratorContainer.class, MachineryJeiRecipeTypes.COAL_GENERATING, 0, 1, 2, 36);
        ...
        registration.addRecipeTransferHandler(LavaGeneratorContainer.class, MachineryJeiRecipeTypes.LAVA_GENERATING, 0, 1, 2, 36);
    }
