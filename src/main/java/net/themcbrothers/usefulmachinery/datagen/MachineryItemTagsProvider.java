...
public class MachineryItemTagsProvider extends BlockTagCopyingItemTagProvider {
    public MachineryItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTags) {
        super(output, lookupProvider, blockTags, UsefulMachinery.MOD_ID);
    }
